...
public class Controller extends Window implements Initializable {
    ...
    void open(ActionEvent event) throws IOException,DocumentException {
        ...
        if(file.getName().endsWith(".rtf")){
            ...
            Codearea.append(stringBuffer.toString(),"");
        }
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        Yaml yaml =new Yaml();
        File f=new File("all.yaml");
        //读入文件
        // load方法支持String，InputStream，Reader作为输入

        try {
            Map result = yaml.load(new FileInputStream(f));
            Object o = result.get("fontsize");
            Object o1 = result.get("fontstyle");
            String string1 = "-fx-font-family:" + o1.toString();
            String string = "-fx-font-size:" + o.toString();
            Codearea.setStyle(string);
            Codearea.setStyle(string1);
